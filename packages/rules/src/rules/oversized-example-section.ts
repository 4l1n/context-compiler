...
export function createOversizedExampleSectionRule(
  threshold: number = EXAMPLE_RATIO_THRESHOLD,
): IRule {
  return {
...
export const oversizedExampleSection: IRule = createOversizedExampleSectionRule();
